...
<body>
				...
				<div class="layui-col-lg12">
					...
					<div class = "layui-hide-xs themenu">
						<ul class="layui-nav" lay-filter="">
						  ...
						  <li class="layui-nav-item"><a href="http://www.sujiuyao.top/ip/api.php" rel = "nofollow" target = "_blank"><i class="layui-icon">&#xe857;</i> API</a></li>
	...
	<div class="footer layui-hide-xs">
		<div class="layui-container">
			<div class="layui-row">
				<div class="layui-col-lg12">
					Copyright &copy; 2017 Powered by <a href = "http://www.sujiuyao.top" target = "_blank">苏玖瑶</a>
				</div>
			</div>
		</div>
	</div>
